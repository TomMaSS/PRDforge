...
- [x] Token savings dashboard — stat cards, per-operation breakdown, activity feed, 7-day trend
...
- [x] Dependency graph — dual view (force-directed SVG graph + list), hover highlighting, drag nodes
- [x] Structured error handling — 9 error codes, frontend error boundaries
- [x] Comments — text selection anchoring, resolve/reopen toggle, edit/delete, highlight in content
